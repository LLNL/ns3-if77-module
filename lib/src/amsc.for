...
*011  WRITE(IOT,9999)3HDN=,DN         
 9011 CONTINUE
*pdb  WRITE(IOT,9999) 'DN = ',DN      
      GO TO 9010        
****  850402            
*012  WRITE(IOT,9999)3HTH=,THETA      
 9012 CONTINUE
*pdb  WRITE(IOT,9999) 'TH = ',THETA   
      GO TO 9010        
****  850402            
*013  WRITE(IOT,9999)3HDZ=,DZ         
9013  CONTINUE
*pdb  WRITE(IOT,9999) 'DZ = ',DZ      
      GO TO 9010        
****  850402            
*010  WRITE(IOT,9999)6HPARAM=,HE,D,DL,THE           
9010  CONTINUE
*pdb  WRITE(IOT,9999) 'PARAM=',HE,D,DL,THE          
*     WRITE(IOT,9999)4HTHA=,THA,THETA               
*pdb  WRITE(IOT,9999) 'THA = ',THA,THETA            
*     WRITE(IOT,9999)3HHL=,HL,HTP     
*pdb  WRITE(IOT,9999) 'HL = ',HL,HTP                
*     WRITE(IOT,9999)3HDN=,DN,GME,RE,X              
*pdb  WRITE(IOT,9999) 'HDN = ',DN,GME,RE,X          
      STOP 'BAD SCAT'                 
...
*pdb  WRITE(IOT,766)VKM(KLM)          
   ...
   16 CONTINUE          
      ...
      K=1               
   25 CONTINUE          
*pdb  IF(NTB.GT.0.AND.NTB.LT.9) WRITE(IOT,821)NTB   
*pdb  IF(KLM.EQ.19) WRITE(IOT,824)    
*pdb  IF(KLM.EQ.10) WRITE(IOT,823)    
*pdb  IF(KLM.EQ.9) WRITE(IOT,822)     
      GO TO 30          
   30 CONTINUE
*pdb  WRITE(IOT,5)      
*pdb  WRITE(IOT,5)      
